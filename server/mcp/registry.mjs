 ...
 * Names come from FEED_NAMES in sources.mjs (the single home — makeCachedFeeds
...
const FEED_DESCRIPTIONS = {
  'status.json': 'n8n execution summary (no container list — see docs/server.md)',
...
/**
 * @param {object} sources - the adapters built at boot in server/index.mjs
