...
- **Architecture Map**: Displays an interactive map of your workflows, updated automatically every 10 minutes. Relationships are calculated deterministically; the per-workflow descriptions are LLM-generated by default (see the note above to keep them local).
