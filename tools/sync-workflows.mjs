...
const WRAPPER = {
  map: [
    ...
    "const fs = require('fs');",
    "const published = { generated_at: new Date().toISOString(), mermaid: out.mermaid, workflows: out.workflows };",
  ...
  ai: [
    ...
    "    body: { model: MODEL, messages: [{ role: 'user', content: prompt }], response_format: { type: 'json_object' }, max_tokens: 3000 },",
    "    json: true,",
    "  });",
