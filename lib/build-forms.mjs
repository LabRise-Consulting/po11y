...
//
// Pure extraction of the "Publish forms.json" Code node from
// workflows/core/maps.json: same traversal order and fallbacks. The caller
// owns I/O (reading the workflow list, writing forms.json) and generated_at.
